...
#
# Conventions:
#   - qtrade_add_support_service(<executable>, <src/service impl dir>)
...
# @param service_impl_dir 实现目录名，对应 src/service/<dir>/
function(qtrade_add_support_service executable_name service_impl_dir)
  ...
  file(GLOB_RECURSE _svc_src CONFIGURE_DEPENDS
    "${QTRADE_SRC_DIR}/service/${service_impl_dir}/*.cpp")
  if(NOT _svc_src)
    message(FATAL_ERROR "No .cpp under src/service/${service_impl_dir}/")
  endif()
