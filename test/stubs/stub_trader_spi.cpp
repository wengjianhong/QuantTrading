...
void StubTraderSpi::PublishOrderEvent(const qtrade_sdk::trader::Order& order_info,
...
void StubTraderSpi::PublishTradeEvent(const qtrade_sdk::trader::Trade& trade_info, std::uint64_t session_id) {
  if (target_ != nullptr) {
