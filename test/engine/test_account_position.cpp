...
TEST(AccountManager, TracksFrozenFundsAndDeduplicatesTrades) {
  ...
  qtrade::sdk::trader::AccountAsset asset;
  ...
  order.side = qtrade::sdk::trader::SideType::kBuy;
  order.status = qtrade::sdk::trader::OrderStatusType::kNotTradedQueueing;
  ...
  trade.side = qtrade::sdk::trader::SideType::kBuy;
  ...
  order.status = qtrade::sdk::trader::OrderStatusType::kPartiallyFilled;
  manager.ApplyOrder(order);
...
TEST(PositionManager, TracksLongShortAndTodayYesterday) {
  ...
  initial.direction = qtrade::sdk::trader::PositionDirectionType::kLong;
  manager.ApplyPositionSnapshot({initial});

  qtrade::sdk::trader::Trade open_long;
  open_long.trade_id = "trade-open-long";
  open_long.instrument = initial.instrument;
  open_long.price = 110.0;
  open_long.volume = 2;
  open_long.side = qtrade::sdk::trader::SideType::kBuy;
  open_long.position_effect = qtrade::sdk::trader::PositionEffectType::kOpen;
  manager.ApplyTrade(open_long);
  manager.ApplyTrade(open_long);
  EXPECT_EQ(manager.GetNetPosition(initial.instrument), 7);

  qtrade::sdk::trader::Trade close_yesterday;
  ...
  close_yesterday.side = qtrade::sdk::trader::SideType::kSell;
  close_yesterday.position_effect = qtrade::sdk::trader::PositionEffectType::kCloseYesterday;
  manager.ApplyTrade(close_yesterday);

  qtrade::sdk::trader::Trade close_today = close_yesterday;
  close_today.trade_id = "trade-close-today";
  close_today.volume = 1;
  close_today.position_effect = qtrade::sdk::trader::PositionEffectType::kCloseToday;
  manager.ApplyTrade(close_today);

  qtrade::sdk::trader::Trade open_short;
  open_short.trade_id = "trade-open-short";
  open_short.instrument = initial.instrument;
  open_short.price = 112.0;
  open_short.volume = 4;
  open_short.side = qtrade::sdk::trader::SideType::kSell;
  open_short.position_effect = qtrade::sdk::trader::PositionEffectType::kOpen;
  manager.ApplyTrade(open_short);

  const auto long_pos = manager.GetPosition(initial.instrument, qtrade::sdk::trader::PositionDirectionType::kLong);
  const auto short_pos = manager.GetPosition(initial.instrument, qtrade::sdk::trader::PositionDirectionType::kShort);
