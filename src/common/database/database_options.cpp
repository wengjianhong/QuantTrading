...
cpp_utils::database::ConnectionConfig BuildLegacyConnectionConfig(const nlohmann::json& database,
                                                                    cpp_utils::database::DatabaseType type) {
  cpp_utils::database::ConnectionConfig options;
...
cpp_utils::database::ConnectionConfig BuildSqliteConnectionConfig(const nlohmann::json& db_config) {
  ...
  return cpp_utils::database::ConnectionConfig{config};
}

cpp_utils::database::ConnectionConfig BuildMySqlConnectionConfig(const nlohmann::json& db_config) {
...
cpp_utils::database::ConnectionConfig BuildPostgreSqlConnectionConfig(const nlohmann::json& db_config) {
...
cpp_utils::database::ConnectionConfig BuildOracleConnectionConfig(const nlohmann::json& db_config) {
...
cpp_utils::database::ConnectionConfig BuildConnectionConfig(const nlohmann::json& database) {
...
void ParsePoolOptions(const nlohmann::json& database, DatabaseOptions& options) {
  ...
  cpp_utils::database::ConnectionPoolConfig pool_opts{options.connection, pool_size};
