/// @file      strategy_config_converter.hpp
/// @brief     config.v1.StrategyConfig ↔ qtrade::strategy::StrategyConfig
/// @author    wengjianhong
/// @date      2026-07-31
/// @copyright CC BY-NC-SA 4.0
#ifndef QTRADE_COMMON_CONVERTER_STRATEGY_CONFIG_CONVERTER_HPP_
#define QTRADE_COMMON_CONVERTER_STRATEGY_CONFIG_CONVERTER_HPP_
...
#endif  // QTRADE_COMMON_CONVERTER_STRATEGY_CONFIG_CONVERTER_HPP_
